...
void loop() {
  ...
  MotorValueL = (((sensorValueL * sensorVelocityL) / 2) + (2 * (sensorValueL - sensorValueR)) /10); //Consider adding MotorValueR/2 to constant at end)
  ...
  MotorValueR = (((sensorValueR * sensorVelocityR) / 2) + (2 * (sensorValueR - sensorValueL)) / 10);
