...
void loop() {
  ...
  //MotorValueL = constrain(MotorValueL, -5000, 5000);
  MotorValueL = map(MotorValueL, -5000, 5000, 0, 255);
  ...
  MotorValueR = constrain(MotorValueR, -5000, 5000);
  MotorValueR = map(MotorValueR, -16000, 16000, 0, 255);
